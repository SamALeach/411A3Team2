...
<table width="990" height="587" border="0" align="center" cellpadding="0" cellspacing="0" background="qtimages/212.jpg"
       id="__01">
    <tr>
        ...
        <td width="367" height="120" valign="top" background="images/middleh40edbhf_03.png">
            <table width="190" border="0" align="center" cellpadding="0" cellspacing="0">
                <form name="form1" method="post" action="index.jsp">
                    ...
                    <tr>
                        <td width="44" height="30"><span class="STYLE3 STYLE7">Username:</span></td>
