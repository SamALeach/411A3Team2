...
<html>
  <head>
    <base href="<%=basePath%>">
    <title>Self driving tour route</title><LINK href="CSS.css" type=text/css rel=stylesheet><script language="javascript" src="js/Calendar.js"></script>
  </head>
  <%
String sql;
ResultSet RS_result;
%>
  <body >
  <p>List of existing self driving tour routes：</p>
  <form name="form1" id="form1" method="post" action="">
      Search: line number:<input name="xianlubianhao" type="text" id="xianlubianhao" /> 线路名称：<input name="xianlumingcheng" type="text" id="xianlumingcheng" /> 目的地：<input name="mudedi" type="text" id="mudedi" />交通工具：<select name='jiaotonggongju' id='jiaotonggongju'><option value="">所有</option></select>出行时间：<input name="chuxingshijian1" type="text" id="chuxingshijian1"  value='' onClick="getDate(form1.chuxingshijian1,'2')" need="1" size="10" />-<input name="chuxingshijian2" type="text" id="chuxingshijian2"  value='' onClick="getDate(form1.chuxingshijian2,'2')" need="1" size="10"  /> 发布人：<input name="faburen" type="text" id="faburen" />
